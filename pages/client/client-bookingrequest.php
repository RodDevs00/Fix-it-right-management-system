...
<body>
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold">Pending Request&nbsp;  <i class="fas fa-fw fa-list"></i></h4>
            </div>
...
$resultpending = $con->query($sqlpending);
            ...
            echo '<td align="right">
            <a type="button" class="btn btn-danger" href="pendingjoborder.php?editId='.$row['transid'] . '"><i class="fas fa-fw fa-th-list"></i> View</a>
            </div> </td>';      
  }
     ?>
                                </tbody>
