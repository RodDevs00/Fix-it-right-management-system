...
<body>  <center><div class="card shadow mb-4 col-xs-12 col-md-8">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold">Supplier's Detail</h4>
            </div>
              <div class="card-body">
...
<div class="table-responsive">
              ...
              <div class="row">
                <div class="col">
                <a href="../supplier.php" type="button" class="btn btn-dark"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Back </a>
                </div>
              </div>
                      </div>
                    </div>
