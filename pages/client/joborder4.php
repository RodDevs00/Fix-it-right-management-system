...
<body>
            ...
            <h4>JOB ORDER<a href="joborder2.php?editId=<?php echo  $tempids;?>"><button class="float-right btn btn-danger">Update</button></a>
            </h4>
 ...
 <td class="font-weight-bold">    <a type="button"  href="../reciept/print-details.php?id=<?php echo $tempids;?>"  class="btn btn-danger" href="#"><i class="fas fa-fw fa-list-alt"></i> Details</a> </td>
<br>
