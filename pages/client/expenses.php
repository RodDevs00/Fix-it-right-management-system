      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold">Expenses&nbsp;<a  href="employee_register.php" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-danger" style="border-radius: 0px;"><i class="fas fa-fw fa-plus "></i></a></h4>
            </div>
