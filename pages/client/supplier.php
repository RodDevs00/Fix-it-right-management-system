      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold">Supplier&nbsp;<a  href="employee_register.php" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-danger" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a></h4>
            </div>
              ...
              <div class="table-responsive">
                ...
                <?php                  
                        ...
                        echo '<td align="right"> <div class="btn-group">
                              <a type="button" class="btn btn-danger" href="view/supplier_details.php?action=edit & id='.$row['s_id'] . '"><i class="fas fa-fw fa-list-alt"></i> Details</a>
                            <div class="btn-group">
