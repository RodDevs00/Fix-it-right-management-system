            ...
            echo '<tr>';
             echo "<td>".$row['userphone']."</td>";
              echo "<td>".$row['carbrand']."</td>";
               ...
               echo "<td>";
               $sqltr  = "SELECT * FROM transacttable WHERE custid = $tempcode AND status ='Pending'";

$resulttr = $con->query($sqltr);

if(mysqli_num_rows($resulttr)>0){
echo "<a type='button' class='btn btn-warning bg-gradient-success btn-block' style='border-radius: 0px;' href='jobordercheckere.php?editId=".$row['id']."'>
...
<div class="card shadow mb-4">
            ...
            <h4 class="m-2 font-weight-bold">Scheduled Today&nbsp;<a  href=""   type="button"  ; data-toggle="modal" data-target="#modal1" class="btn btn-danger" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a></h4>
            </div>
            <div class="card-body">
...
<div class="card shadow mb-4">
            <div class="card-header py-3">
            <h4 class="m-2 font-weight-bold">Approved&nbsp; <i class="fas fa-fw fa-check"></i></h4>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"> 
...
$resultpending = $con->query($sqlpending);
             while($row = $resultpending->fetch_assoc()) {
              ...
              echo '<td align="right"> <div class="btn-group">
                              ...
                              <a type="button" class="btn btn-danger" href="approved.php?editId='.$row['transid'] . '"><i class="fas fa-fw fa-list-alt"></i> Details</a>
...
<div class="card shadow mb-4">
            <div class="card-header py-3">
            <h4 class="m-2 font-weight-bold">Pending&nbsp;<i class="fas fa-fw fa-clock"></i></h4>
            </div>
            <div class="card-body">
               <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"> 
...
$resultpending = $con->query($sqlpending);
             while($row = $resultpending->fetch_assoc()) {
              ...
              echo "<td bgcolor='yellow' class='font-weight-bold'>".$row['status']."</td>";
                echo '<td align="right"> <div class="btn-group">
                              ...
                              <a type="button" class="btn btn-danger" href="cancellation.php?editId='.$row['transid'] . '"><i class="fas fa-fw fa-list-alt"></i> Details</a>
     ...
     ?>
       ...
       <div class="card shadow mb-4">
            <div class="card-header py-3">
            <h4 class="m-2 font-weight-bold">Rejected&nbsp;<i class="fas fa-fw fa-trash"></i></h4>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"> 
