...
$temps = $_GET['editId'];
  ...
  $result = mysqli_query($con,"SELECT * from cardata WHERE id = $temps;");
  ...
  <div class="container">
   ...
   <center><div class="card shadow mb-4 col-xs-12 col-md-8">
            <div class="card-header py-3">
              ...
              <hr>
                <button type="submit" name="updatecarbrand" value="submit"  class="btn btn-danger"><i class="fa fa-edit fa-fw"></i>Update</button> 
                <a  type="button" class="btn btn-dark" href="../vehicle-user.php?editId=<?php echo ''.$row['plateid'].''?> "> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Back </a>
