  ...
  <div class="container">
   ...
   <center><div class="card shadow mb-4 col-xs-12 col-md-8">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold">Edit Inventory</h4>
            </div>
            <div class="card-body">
            ...
            <form name="frmUser" method="post" action="../process/process.php">
              ...
              <hr>
                <button type="submit" name="updateinventory" value="submit"  class="btn btn-danger"><i class="fa fa-edit fa-fw"></i>Update</button> 
                <a  type="button" class="btn btn-dark" href="../inventory.php "> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Back </a>
              </form>  
          </div>
  </div>
  </div>
