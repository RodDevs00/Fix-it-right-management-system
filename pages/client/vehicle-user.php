    ...
    if ($temp_type == "admin") { ?>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
               <h4 class="m-2 font-weight-bold">Vehicles of <?php echo $name; echo "  ",$lastname;?> &nbsp;<a  href="employee_register.php" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-danger" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a></h4>
            </div>
              ...
              <div class="table-responsive">
                ...
                <?php                  
                      ...
                      echo '<td align="right"> <div class="btn-group">
                             ...
                             <a type="button" class="btn btn-danger" href="view/vehicle_details2.php?editId='.$row['id'] . '"><i class="fas fa-fw fa-list-alt"></i> Details</a>
                              <a type="button" class="btn btn-danger dropdown no-arrow" data-toggle="dropdown" style="color:white;">
                              ... <span class="caret"></span></a>
                            <ul class="dropdown-menu text-center" role="menu">
                                <li>
                                 </a>
                                   <a type="button" class="btn btn-warning bg-gradient-success btn-block" style="border-radius: 0px;" href="vehicle-transaction.php?editId='.$row['id']. '">
                                    <i class="fas fa-fw fa-car"></i> Transactions
                                  </a>
                                  <a type="button" class="btn btn-warning bg-gradient-warning btn-block" style="border-radius: 0px;" href="#.php?editId='.$row['id']. '">
      ...
      <?php } else { ?>
            <div class="card shadow mb-4">
            <div class="card-header py-3">
               <h4 class="m-2 font-weight-bold">My Vehicles&nbsp;<a  href="employee_register.php" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-danger" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a></h4>
            </div>
                      ...
                      echo '<td align="right"> <div class="btn-group">
                            ...
                            <ul class="dropdown-menu text-center" role="menu">
                                <li>
                                  ...
                                  <a type="button" class="btn btn-warning bg-gradient-warning btn-block" style="border-radius: 0px;" href="update/vehicle_brand_edit.php?editId='.$row['id']. '">
                                    <i class="fas fa-fw fa-edit"></i> Edit
                                  </a>
                                   <a type="button" class="btn btn-danger bg-gradient-btn-danger btn-block" style="border-radius: 0px;" href="process/process.php?deletecustomer='.$row['id']. '">
                                    <i class="fas fa-fw fa-trash"></i> Delete
