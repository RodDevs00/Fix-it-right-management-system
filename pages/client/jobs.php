      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold">Jobs Offered&nbsp;<a  href="employee_register.php" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-danger" style="border-radius:;"><i class="fas fa-fw fa-plus"></i></a></h4>
            </div>
              ...
              <div class="table-responsive">
                ...
                <?php                  
                        ...
                        echo '<td align="right"> 
                                  ...
                                  <a type="button" class="btn btn-dark" href="update/jobs_edit.php?editId='.$row['job_id']. '">
                                    <i class="fas fa-fw fa-edit"></i> Edit
                                  </a>
                                  <button href="process/process.php?deletejob='.$row['job_id']. '" type="button"  class="btndel btn btn-danger" >
