<?php
  ...
  $sql2 = "SELECT * FROM product_inventory GROUP by p_name";
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="card shadow mb-4">
              ...
              <h4 class="m-2 font-weight-bold">Purchased Order&nbsp;</h4>
            </div>
            ...
            <div class="card-body">
                ...
                <?php                  
                    ...
                    ?> 
                       ...
                       <?php } else { ?>
                         <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold">Purchase Order&nbsp;<a  href="employee_register.php" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-danger" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a></h4>
            </div>
