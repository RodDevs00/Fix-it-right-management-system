    ...
    if ($temp_type == "admin") { ?>
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold ">Vehicles&nbsp;</h4>
            </div>
              ...
              <div class="table-responsive">
                ...
                <?php                  
                      ...
                      echo '<td align="right"> <div class="btn-group">
                              ...
                              <a type="button" class="btn btn-danger" href="view/vehicle_details.php?editId='.$row['plateid'] . '"><i class="fas fa-fw fa-list-alt"></i> Details</a>
                            <div class="btn-group">
                            ...
                            <ul class="dropdown-menu text-center" role="menu">
                                <li>
                                    ...
                                    <a type="button" class="btn btn-dark btn-block" style="border-radius: 0px;" href="view/vehicle_transaction_details.php?editId='.$row['id']. '">
                                    <i class="fas fa-fw fa-car"></i> Transactions
                                  </a>
                                  <a type="button" class="btn btn-dark btn-block" style="border-radius: 0px;" href="update/vehicle_edit.php?editId='.$row['id']. '">
              ...
              <div class="table-responsive">
                 <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"> 
                  <thead>
                    ...
                    <tbody>
                <?php                  
                        $query = "SELECT * FROM cardata JOIN users on cardata.plateid = users.id WHERE plateid = '$tempcode';";
                        $result = mysqli_query($con, $query) or die (mysqli_error($db));
                        while ($row = mysqli_fetch_assoc($result)) {
                            $fn = $row['firstname'];
                            $ln = $row['lastname'];
