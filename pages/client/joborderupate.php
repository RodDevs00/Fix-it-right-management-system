...
$sqlmg  = "SELECT transid FROM transacttable WHERE carid = '$tempid';";

$resultmg = $con->query($sqlmg);
     ...
     <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold">Information&nbsp;<a  href="cancellation.php?editId=<?php echo  $temporaryid;?>" type="button" class="float-right btn btn-primary bg-gradient-primary" style="border-radius: 0px;">Return<i class="fas fa-fw fa-edit"></i></a></h4>
            </div>
            ...
            <label style="font-weight: bold;">Transaction ID</label>
             <input readonly type = "text" value = "<?php echo $mistid?>"class="bg-white form-control" required>
              

          </div>
          <div class="col-md-4 mb-3">
            <label style="font-weight: bold;">Customer's Name</label>
     <input type = "text" readonly value = "<?php echo $tempname2," ",$templname2?>"class="bg-white form-control" required>
          ...
          <div class="col-md-4 mb-3">
            <label style="font-weight: bold;">Vehicle</label>
                                 <input type = "text" readonly value = "<?php echo $tempcarname,"  - ",$tempcarmodel?>"class="bg-white form-control" required>
          ...
          <div class="col-md-2 mb-3">
                  <label style="font-weight: bold;">Status</label>
                   <input type = "text" readonly value = "<?php echo $miststatus;?>"class="bg-white form-control" required>                  </div>
                  </div>
            </div>
          </div>
          <!-- -->
           ...
           <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold">Services&nbsp;</h4>
            </div>
            
            <div class="card-body">
            <div id="magic1">
            <?php
$sqltransaction5= "SELECT * FROM booking_table WHERE transaction_id ='$temporaryid'";
   ...
   <center><div class="card shadow mb-4 col-xs-12 col-md-12 border-bottom-primary">
            ...
            <form  method="post" action="process/process.php">
              <div class="form-group row text-left font-weight-bold">
                ...
                Current Priority Number
                  <input type="text" class="form-control" name="prnumber" id="prnumber"  value="<?php echo $mistpr;?>"    required>
                </div>
              ...
              </div> <div hidden class="form-group row text-left font-weight-bold">
                <div class="col-sm-3" style="padding-top: 5px;">
                Current bid
                </div>
                <input type="text" class="form-control" name="bid" id="bid"  value="<?php echo $temporaryid;?>"  required>
              </div>
              ...
              <div class="form-group row text-left font-weight-bold">
               ...
               <div class="col-sm-9">
                    <input  type="input" id="magic" id="transact_sched" min="<?php echo $currentdate;?>" class="form-control" value = "<?php echo "$mistsched";?>"name="transact_sched" id="transact_sched" required>
        ...
        <option value="<?php echo $mistpay;?>"><?php echo $mistpay;?></option>
        ...
        <option value="Credit Card">Credit</option>
                ...
                <button type="submit" name="bookingrequestupdate" value="submit" id="submit" class="btn btn-primary btn-block"><i class="fa fa-edit fa-fw"></i>Update</button> 
              </form>  
          </div>
  </div>
...
<br>
 <td class="font-weight-bold"> <a type="button"  ; data-toggle="modal" data-target="#modal1" class="btn btn-primary btn-block bg-gradient-primary" href="transact-bill2.php"><i class="fas fa-fw fa-edit"></i> Update</a> </td>
<br>
