           ...
           <table border="1" width="100%" > 
             ...
             <tbody>
                <?php 
                      ...
                      $sqlinventory = "SELECT SUM(expense_price) as totalp, expense_name, expense_date,COUNT(expense_id) as magiccount FROM expense_table  WHERE MONTH(`expense_date`)>= '$test' AND MONTH(`expense_date`) <= '$test2' GROUP BY expense_name ORDER by expense_date";
             ...
             <tbody>
                <?php 
                 $sqlrun = "SELECT date_format(expense_date, '%M'),expense_date,SUM(expense_price) as totalexpenseprice FROM expense_table WHERE MONTH(`expense_date`) >= '$test' AND MONTH(`expense_date`) <= '$test2' GROUP BY date_format(expense_date,'%M')";
