           ...
           <table border="1" width="100%" > 
             ...
             <tbody>
                <?php 
                     ...
                     $sql = "SELECT * FROM transaction_table JOIN employee on encoder = employee.employee_fname WHERE transaction_sched >= '$chosendate' AND transaction_sched <= '$chosendate2' ORDER BY price ASC";
             ...
             <tbody>
             <?php
                $totalsql = "SELECT SUM(price) as totals, COUNT(name) as count FROM transaction_table WHERE transaction_sched >= '$chosendate' AND transaction_sched <= '$chosendate2';";
