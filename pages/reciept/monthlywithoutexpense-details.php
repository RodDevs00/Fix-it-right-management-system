...
table.striped tr:nth-of-type(2n) {
    background-color: #f3f3f6;
           ...
           <table style="border: none;" > 
             ...
             <tbody>
            <td style="padding: none;">Monthly Parts & Materials</td>
            <td><?php echo date('F, Y', $mycur);?></td>
             ...
             <tbody>
                <?php 
                    $currentdate = date("Y-m-d");
                     ...
                     $sqlinventory = "SELECT SUM(item_total) as item_total, SUM(item_amount) as item_amount, item_name, item_price FROM parts_table WHERE MONTH(`item_transaction_sched`)=MONTH( CURRENT_DATE ) GROUP by item_name ORDER BY item_total ASC";
             ...
             <tbody>
                ...
                $sqltotal = "SELECT SUM(item_total) as totals, SUM(item_amount) as count FROM parts_table WHERE MONTH(`item_transaction_sched`)=MONTH( CURRENT_DATE )";
