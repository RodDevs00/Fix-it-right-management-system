...
table.striped tr:nth-of-type(2n) {
    background-color: #f3f3f6;
           ...
           <table style="border: none;" > 
             ...
             <tbody>
            <td style="padding: none;">Monthly Labor & Services</td>
             ...
             <tbody>
                <?php 
                    $currentdate = date("Y-m-d");
                     $sqlinventory = "SELECT COUNT(name) as countname,name,price,transaction_sched,SUM(price) as sumprice FROM transaction_table WHERE MONTH(`transaction_sched`)=MONTH( CURRENT_DATE ) GROUP BY name ORDER BY price ASC";
...
$sqltotal = "SELECT SUM(price) as totals, COUNT(name) as count FROM transaction_table WHERE MONTH(`transaction_sched`)=MONTH( CURRENT_DATE )";
