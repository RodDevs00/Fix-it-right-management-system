...
table.striped tr:nth-of-type(2n) {
    background-color: #f3f3f6;
           ...
           <table style="border: none;" > 
            ...
            <td><?php echo date('F, Y', $mycur1);?></td>
            </tbody>
                </table>
           ...
           <table border="1" width="100%" > 
             ...
             <tbody>
                <?php 
                    $cur = date("Y-m-d");
                      $sqlinventory = "SELECT * FROM expense_table  WHERE MONTH(`expense_date`)=MONTH( CURRENT_DATE )  ORDER by expense_date ASC ";
               ...
               <table border="1" width="100%" > 
                    <?php
                     $totalsql = "SELECT SUM(expense_price) as totals,COUNT(expense_id) as count FROM expense_table WHERE MONTH(`expense_date`)=MONTH( CURRENT_DATE );";
