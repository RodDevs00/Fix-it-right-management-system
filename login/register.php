                    ...
                    <div class="col">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-black-900 mb-4">Create an Account</h1>
                            </div>
                             ...
                             <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                               ...
                               <button class="btn btn-danger btn-user btn-block fnt" type="submit" name="submit" value="submit" id="submit">Register Account</button>
                                <hr>
                                
                            </form>
                            <hr>
                            <div class="text-center">
                                <a class="small" style="color:black;" href="login.php">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
