...
$tempcode = $_SESSION['id'];
 ...
 $sqlorder = "SELECT * FROM product_inventory GROUP BY p_name";
                        ...
                        <div class="input-group">
                             ...
                             <ul class="navbar-nav ">
                                            <li class="nav-item dropdown" >
                                                <a class="navbar-brand" href="#">Fix It Right Garage</a>
                     ...
                     if ($temp_type == "admin") { ?>
                            <li class="nav-item dropdown no-arrow mx-1">
                             <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <!-- Counter - Alerts -->
                                <?php 
                               $countsql = "SELECT count(*) as total FROM transacttable WHERE status = 'Pending'";
                               ...
                               $nummy = $data['total'];
                                ...
                                if ($nummy >3) {
                                 ...
                                 <?php
                                  ...
                                  ?>    
                                  <span class="badge badge-danger badge-counter"><?php echo $nummy;?></span>
                                 <?php
                                }
                                 ?>
 ...
 <?php 
                        ...
                        <?php } else { ?>
                             ...
                             <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <!-- Counter - Alerts -->
                                <?php 
                               $countsql = "SELECT count(*) as total FROM transacttable WHERE custid = $tempcode AND status = 'Approved'";
                               $countresult= mysqli_query($con,$countsql);
                               $data = mysqli_fetch_assoc($countresult);
                                //echo $data['total'];
                               $nummy = $data['total'];
                                $countsql1 = "SELECT count(*) as total1 FROM transacttable WHERE custid = $tempcode AND status = 'Rejected'";
                               $countresult1= mysqli_query($con,$countsql1);
                               $data1 = mysqli_fetch_assoc($countresult1);
                                //echo $data['total'];
                               $nummy1 = $data1['total1'];
                               $nummy2 = $nummy +$nummy1;
                                ?>
                                ...
                                if ($nummy >3) {
                                 ...
                                 <?php
                                  ...
                                  ?>    
                                  <span class="badge badge-danger badge-counter"><?php echo $nummy2;?></span>
                                 <?php
                                }
                                 ?>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <h6 class="dropdown-header">
                                    ...
                                    <?php 
                                     $sql2 = "SELECT * from transacttable  WHERE custid = $tempcode ORDER by transact_sched;" ;
                                $result2 = $con->query($sql2);
                                while($row = $result2->fetch_assoc()) {
                                    $hello = $row['transact_sched'];
                                    $mydate = strtotime($hello);
                                     ...
                                     if ($row['status'] === "Approved"){
                                        echo '<a class="dropdown-item d-flex align-items-center" href="approved.php?editId=';
                                        echo $help;
                                        echo '">';
                                        echo '<div class="mr-3">';
                                        echo '<div class="icon-circle bg-success">';
                                        echo '<i class="fas fa-check text-white"></i>';
                                        echo '</div>';
                                        echo '</div>';
                                         echo '<div>';
                                         echo '<h6 class="font-weight-bold"></h6>';
